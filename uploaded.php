...
if (isset($_POST['submit']))
{
	...
	$userId="user@test.mail";
	$document=str_replace(" ","_",$_FILES['userfile']['name']);
	$document=$uploadDName.$document;
	$docType="pdf";
	$active='active';
	...
	$sql="Insert into `documents` (`document`,`path`,`user_id`,`date`,`status`,`file_type`,`content`) values ('$document','$path','$userId','$date','$active','$fileType','$contentsClean')";
	$dblink->query($sql) or
